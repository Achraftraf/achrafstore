...
<section class="contact">
   ...
   <form action="" method="POST">
      ...
      <input type="email" name="email" class="box" required placeholder="entrer votre e-email">
      <input type="number" name="number" min="0" class="box" required placeholder="entrer votre numero">
