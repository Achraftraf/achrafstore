...
<section class="search-form">
   ...
   <form action="" method="POST">
      <input type="text" class="box" name="search_box" placeholder="rechercher des produits...">
...
<section class="products" style="padding-top: 0; min-height:100vh;">
   ...
   <form action="" class="box" method="POST">
      ...
      <input type="submit" value="ajouter au soutaits" class="option-btn" name="add_to_wishlist">
