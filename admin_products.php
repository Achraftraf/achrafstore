...
<section class="add-products">
   ...
   <form action="" method="POST" enctype="multipart/form-data">
      <div class="flex">
         <div class="inputBox">
         <input type="text" name="name" class="box" required placeholder="entrer le nom du produit">
         ...
         <div class="inputBox">
         <input type="number" min="0" name="price" class="box" required placeholder="entrer le prix du produit">
...
<section class="show-products">
   ...
   ?>
   <div class="box">
      <div class="price"><?= $fetch_products['price']; ?> MAD</div>
      ...
      <div class="flex-btn">
         ...
         <a href="admin_products.php?delete=<?= $fetch_products['id']; ?>" class="delete-btn" onclick="return confirm('supprimer ce produit ?');">supprimer</a>
      </div>
   </div>
   <?php
      }
   }else{
      echo '<p class="empty">maintenant des produits ajoutés encore !</p>';
   }
   ?>
