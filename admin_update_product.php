...
<section class="update-product">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="text" name="name" placeholder="entrer le nom du produit" required class="box" value="<?= $fetch_products['name']; ?>">
      <input type="number" name="price" min="0" placeholder="entrer le prix du produit" required class="box" value="<?= $fetch_products['price']; ?>">
