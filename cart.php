...
<section class="shopping-cart">
   ...
   <form action="" method="POST" class="box">
      <a href="cart.php?delete=<?= $fetch_cart['id']; ?>" class="fas fa-times" onclick="return confirm('supprimer ceci du panier ?');"></a>
      ...
      <div class="sub-total"> prix total : <span><?= $sub_total = ($fetch_cart['price'] * $fetch_cart['quantity']); ?>MAD</span> </div>
   </form>
   <?php
