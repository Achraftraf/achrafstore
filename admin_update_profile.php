...
if(isset($_POST['update_profile'])){
   ...
   $old_pass = $_POST['ancien mot de passe'];
   $update_pass = md5($_POST['passe de mise à jour']);
   $update_pass = filter_var($update_pass, FILTER_SANITIZE_STRING);
   $new_pass = md5($_POST['nouveau mot de passe']);
   $new_pass = filter_var($new_pass, FILTER_SANITIZE_STRING);
   $confirm_pass = md5($_POST['Confirmez le mot de passe']);
...
<section class="update-profile">
   ...
   <h1 class="title">mettre à jour le profile</h1>
   ...
   <form action="" method="POST" enctype="multipart/form-data">
      ...
      <div class="flex">
         <div class="inputBox">
            ...
            <span>e-mail :</span>
            <input type="email" name="email" value="<?= $fetch_profile['email']; ?>" placeholder="e-mail de mise à jour" required class="box">
         ...
         <div class="inputBox">
            ...
            <input type="password" name="new_pass" placeholder="Entrer un nouveau mot de passe" class="box">
      ...
      <div class="flex-btn">
         ...
         <a href="admin_page.php" class="option-btn">revenir </a>
      </div>
   </form>
